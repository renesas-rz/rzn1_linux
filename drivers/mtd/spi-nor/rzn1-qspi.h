...
#define	CQSPI_REG_CONFIG_AHB_ENABLE_MASK	BIT(16)
...
#define CQSPI_REG_WRPROT_INVERT			BIT(0)
#define CQSPI_REG_IRQMASK_WP			BIT(4)
#define CQSPI_REG_WRPROT_ENABLE_MASK		BIT(1)
